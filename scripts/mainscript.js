...
form.addEventListener("submit", submittedtracking);
...
trackingCode.addEventListener("input", validatetracking);
...
function addToLocalStorageTracking() {
  //The following is to declare localStorage keys, using values inside the labels.
